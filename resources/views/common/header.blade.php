        ...
        <div class="container">
            <div class="navbar-header">
                ...
                <div class="header-top">
                    <div class="row">
                        <div class="col-sm-6">
                            <div class="logo"><a href="index.html"><span class="hidden-xs"><img src="images/logo.gif"
                                            alt="Logo"></span><span class="visible-xs"><img src="images/logo-mobile.png"
                                            alt="Logo"></span></a></div>
                        </div>
                        <div class="col-sm-6">
                            <div class="phone">
